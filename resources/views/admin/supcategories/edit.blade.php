...
@section('content')
    <main class="content">
        <h1 class="h3 mb-3"><strong>Edit</strong> SupCategories</h1>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('supcategories.update', $supcategories->id) }}" method="post"
                              enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <label for="example-text-input" class="form-control-label">Title</label>
                            <input name="title" type="text" class="form-control mb-3"
                                   value="{{ $supcategories->title }}" required>
                            <div class="mb-3">
