    ...
    <main class="content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary mb-3"  href="{{route('announcements.create')}}">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($announcements as $announcement)
                            <tr>
                                ...
                                <td>
                                 {{\App\Models\Announcement::TYPES[$announcement->type]}}
                                </td>
                                <td>
                                 {{$announcement->price}}
                                </td>
                                <td>
                                    ...
                                    <a href="{{route('announcements.show',$announcement->id)}}" class="btn btn-success">
